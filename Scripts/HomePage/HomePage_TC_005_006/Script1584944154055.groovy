...
testLogger = customReport.startTestCase('TC_005_006', 'To verify the Light box is not display when it is disabled in BCC.').assignCategory(
    'smoke_Test', 'HomePage')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/HomePage/a_VerifyCookiePolicy'), 5)

testLogger.log(Status.PASS, 'TC_006_Accept Cookie Polict link displayed')

WebUI.click(findTestObject('Page_Michael Kors UK Designer handbags clot_5e67ef/a_I ACCEPT'))

WebUI.verifyElementNotPresent(findTestObject('Object Repository/HomePage/verify_LightBoxNotPresent'), 10)

testLogger.log(Status.PASS, 'TC_005_Light Box PopUp is not displayed')
